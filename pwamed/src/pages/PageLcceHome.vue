...
<template>
  <csi-page padding>
    ...
    <template v-else>
      <fse-profile-choice :confirming="isLoadingPatientInfo" :role="userRole"
...
import {apiErrorNotify, isEmpty, notifyError} from "src/services/utils";
...
import {APP, CONSENTS_ACTIVATION, DOCUMENTS, HOME, PATIENT_INFO} from "src/router/routes";
