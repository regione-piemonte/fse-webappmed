...
import it.csi.dma.apiopsan.verificaservices.dmacc.VerificaOscuramentoDocResponse;
import it.csi.dma.apiopsan.verificaservices.dmacc.VerificaPinResponse;
...
@XmlSeeAlso({
    VerificaOscuramentoDocResponse.class,
    VerificaPinResponse.class,
    VerificaUtenteAbilitatoResponse.class
})
