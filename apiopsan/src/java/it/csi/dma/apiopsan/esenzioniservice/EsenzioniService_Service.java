 ...
 * 2022-09-12T06:40:10.766+02:00
 * Generated source version: 3.5.3
 *
 */
@WebServiceClient(name = "EsenzioniService",
                  wsdlLocation = "file:/C:/axis-1_4/EsenzioniService.wsdl",
...
public class EsenzioniService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/axis-1_4/EsenzioniService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EsenzioniService_Service.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/axis-1_4/EsenzioniService.wsdl");
        }
        WSDL_LOCATION = url;
    }
