 ...
 * generated in the it.csi.dma.apiopsan.ultimodocumentoservice.dma package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: it.csi.dma.apiopsan.ultimodocumentoservice.dma
     * 
     */
    ...
    /**
     * Create an instance of {@link MetadatiUltimoDocumento }
     * 
     */
    public MetadatiUltimoDocumento createMetadatiUltimoDocumento() {
        return new MetadatiUltimoDocumento();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link MetadatiUltimoDocumento }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link MetadatiUltimoDocumento }{@code >}
     */
    @XmlElementDecl(namespace = "http://dma.csi.it/", name = "metadatiDocumento")
    public JAXBElement<MetadatiUltimoDocumento> createMetadatiDocumento(MetadatiUltimoDocumento value) {
        return new JAXBElement<MetadatiUltimoDocumento>(_MetadatiDocumento_QNAME, MetadatiUltimoDocumento.class, null, value);
    }
