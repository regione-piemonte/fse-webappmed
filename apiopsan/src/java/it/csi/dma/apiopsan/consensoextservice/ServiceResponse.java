...
@XmlType(name = "serviceResponse", namespace = "http://dmacc.csi.it/", propOrder = {
    "codifiche",
    "errori",
    "esito"
})
@XmlSeeAlso({
    StatoConsensiResponse.class,
    ComunicazioneConsensiResponse.class,
    RecuperoInformativaResponse.class
})
