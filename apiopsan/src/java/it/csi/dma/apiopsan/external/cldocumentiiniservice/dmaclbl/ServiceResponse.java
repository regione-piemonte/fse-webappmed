...
import it.csi.dma.apiopsan.external.cldocumentiiniservice.dma.Codifica;
import it.csi.dma.apiopsan.external.cldocumentiiniservice.dma.Errore;
import it.csi.dma.apiopsan.external.cldocumentiiniservice.dma.RisultatoCodice;
...
@XmlSeeAlso({
    RicercaDocumentiIniResponse.class,
    RecuperoDocumentoIniResponse.class
})
