...
public class EpisodioEstesoMapper implements RowMapper<EpisodioEsteso> {

	@Override
    public EpisodioEsteso mapRow(ResultSet resultSet, int rowNumber) throws SQLException {
		EpisodioEsteso result = new EpisodioEsteso();
