...
public class SintesiMieiRefertiMapper implements RowMapper<SintesiDocumento> {
    ...
    public SintesiDocumento mapRow(ResultSet resultSet, int rowNumber) throws SQLException {
		...
		medico.setTipoMedico(resultSet.getString("tipo_medico"));
		medici.add(medico);
