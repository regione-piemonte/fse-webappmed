 ...
 * 2022-08-05T14:50:19.718+02:00
 * Generated source version: 3.5.3
 *
 */
@WebService(targetNamespace = "http://dmaccbl.csi.it/", name = "PazienteService")
@XmlSeeAlso({ObjectFactory.class, it.csi.dma.apiopsan.pazienteservice.dma.ObjectFactory.class, it.csi.dma.apiopsan.pazienteservice.dmacc.ObjectFactory.class})
...
public interface PazienteService {
    ...
    public it.csi.dma.apiopsan.pazienteservice.dmacc.NotificaOscuramentoNREResponse notificaOscuramentoNRE(

        @WebParam(partName = "NotificaOscuramentoNRERequest", name = "NotificaOscuramentoNRERequest", targetNamespace = "http://dmacc.csi.it/")
        it.csi.dma.apiopsan.pazienteservice.dmacc.NotificaOscuramentoNRERequest notificaOscuramentoNRERequest
    );
    ...
    public it.csi.dma.apiopsan.pazienteservice.dmacc.NotificaDocumentoNonScaricabileResponse notificaDocumentoNonScaricabile(
        ...
        it.csi.dma.apiopsan.pazienteservice.dmacc.NotificaDocumentoNonScaricabileRequest notificaDocumentoNonScaricabileRequest
    );
